...
public class HystrixPlugins {
     ...
     * <p>
     * Override default by using {@link #registerEventNotifier(HystrixEventNotifier)} or setting property (via Archaius): <code>com.netflix.hystrix.plugin.HystrixEventNotifier.implementation</code> with the full classname to
     * load.
     * 
     ...
     * <p>
     * Override default by using {@link #registerConcurrencyStrategy(HystrixConcurrencyStrategy)} or setting property (via Archaius): <code>com.netflix.hystrix.plugin.HystrixConcurrencyStrategy.implementation</code> with the
     ...
     * <p>
     * Override default by using {@link #registerMetricsPublisher(HystrixMetricsPublisher)} or setting property (via Archaius): <code>com.netflix.hystrix.plugin.HystrixMetricsPublisher.implementation</code> with the full
     * classname to load.
     * 
     ...
     * <p>
     * Override default by using {@link #registerPropertiesStrategy(HystrixPropertiesStrategy)} or setting property (via Archaius): <code>com.netflix.hystrix.plugin.HystrixPropertiesStrategy.implementation</code> with the full
     * classname to load.
     * 
     ...
     * <ol>
     * <li>System property of key: <code>com.netflix.hystrix.plugin.HystrixDynamicProperties.implementation</code> with the class as a value.</li>
     ...
     * <p>
     * Override default by using {@link #registerCommandExecutionHook(HystrixCommandExecutionHook)} or setting property (via Archaius): <code>com.netflix.hystrix.plugin.HystrixCommandExecutionHook.implementation</code> with the
     * full classname to
     * load.
     * 
    ...
    private static <T> T getPluginImplementationViaProperties(Class<T> pluginClass, HystrixDynamicProperties dynamicProperties) {
        ...
        String propertyName = "com.netflix.hystrix.plugin." + classSimpleName + ".implementation";
    ...
    private static HystrixDynamicProperties resolveDynamicProperties(ClassLoader classLoader, LoggerSupplier logSupplier) {
        ...
        if (hp != null) {
            logSupplier.getLogger().debug(
                    ...
                    + "\"com.netflix.hystrix.plugin.HystrixDynamicProperties.implementation\". Using class: {}",
